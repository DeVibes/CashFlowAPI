...
{
    public Task<ApprovedUsersStatus> ApproveUser(string username, string guid, CancellationToken cancellationToken = default);
    public Task<ApprovedUsersStatus> DisapproveUserById(string guid, CancellationToken cancellationToken = default);
    ...
    public Task<ApprovedUserReadModel?> GetApprovedUserById(string guid, CancellationToken cancellationToken = default);
